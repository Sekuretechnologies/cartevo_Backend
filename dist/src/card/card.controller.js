...
let CardController = class CardController {
    ...
    async fundCard(business, cardId, fundDto) {
        const result = await this.cardService.fundCard(business.businessId, cardId, fundDto);
        return {
    ...
    async withdrawFromCard(business, cardId, withdrawDto) {
        const result = await this.cardService.withdrawFromCard(business.businessId, cardId, withdrawDto);
        return {
            success: result.success,
            message: result.message,
        };
    ...
    async terminateCard(business, cardId) {
        const result = await this.cardService.terminateCard(business.businessId, cardId);
        return {
            success: result.success,
            message: result.message,
        };
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: "Permanently terminate a card and return remaining balance to company USD wallet",
    }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], CardController.prototype, "terminateCard", null);
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({
