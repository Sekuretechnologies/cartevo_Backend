...
export class UserController {
  ...
  async registerUser(@Body() registerDto: RegisterUserDto): Promise<SuccessResponseDto> {
...
export class AuthController {
  ...
  async verifyOtp(@Body() verifyOtpDto: VerifyOtpDto): Promise<LoginSuccessResponseDto> {
